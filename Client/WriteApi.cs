...
{
    /// <summary>
    ///     Precision of Dates that are written to the InfluxDB 2.0.
    /// </summary>
    ...
    // TODO gzip
    public class WriteApi : AbstractClient, IDisposable
    {
        ...
        protected internal WriteApi(DefaultClientIo client, WriteOptions writeOptions) : base(client)
        {
