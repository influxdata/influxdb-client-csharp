...
namespace InfluxDB.Client.Generated.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class TelegrafPluginInputSwap :  IEquatable<TelegrafPluginInputSwap>
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        public TelegrafPluginInputSwap(NameEnum name = default(NameEnum), TypeEnum type = default(TypeEnum), string comment = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for TelegrafPluginInputSwap and cannot be null");
            }
            else
            {
                this.Type = type;
