...
namespace InfluxDB.Client.Generated.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class TelegrafPluginInputKubernetes :  IEquatable<TelegrafPluginInputKubernetes>
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        public TelegrafPluginInputKubernetes(NameEnum name = default(NameEnum), TypeEnum type = default(TypeEnum), string comment = default(string), TelegrafPluginInputKubernetesConfig config = default(TelegrafPluginInputKubernetesConfig))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for TelegrafPluginInputKubernetes and cannot be null");
            }
            else
            {
                this.Type = type;
