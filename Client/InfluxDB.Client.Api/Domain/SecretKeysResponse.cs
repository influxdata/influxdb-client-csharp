...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// SecretKeysResponse
    /// </summary>
    [DataContract(Name = "SecretKeysResponse")]
    public partial class SecretKeysResponse : IEquatable<SecretKeysResponse>
    {
        /// <summary>
        ...
        public SecretKeysResponse(List<string> secrets = default(List<string>), SecretKeysResponseAllOfLinks links = default(SecretKeysResponseAllOfLinks))
        {
