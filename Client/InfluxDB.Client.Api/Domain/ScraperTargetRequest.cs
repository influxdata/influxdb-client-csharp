...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "ScraperTargetRequest")]
    public partial class ScraperTargetRequest : IEquatable<ScraperTargetRequest>
    {
        ...
        public ScraperTargetRequest(string name = default(string), TypeEnum? type = default(TypeEnum?), string url = default(string), string orgID = default(string), string bucketID = default(string), bool allowInsecure = false)
        {
            this.Name = name;
            this.Type = type;
            this.Url = url;
