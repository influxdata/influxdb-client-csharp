...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class MemberAssignment : Statement, IEquatable<MemberAssignment>
    {
        ...
        public MemberAssignment(string type = default, MemberExpression member = default,
            Expression init = default) : base()
        {
            Type = type;
            Member = member;
            Init = init;
        ...
        {
            return Equals(input as MemberAssignment);
        }
        ...
        public bool Equals(MemberAssignment input)
        {
            ...
            return base.Equals(input) &&
                   ...
                   ) && base.Equals(input) && Member != null && Member.Equals(input.Member) && base.Equals(input) &&
                   Init != null && Init.Equals(input.Init);
        }
