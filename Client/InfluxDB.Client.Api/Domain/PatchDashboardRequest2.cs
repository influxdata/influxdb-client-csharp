...
{
    /// <summary>
    /// PatchDashboardRequest2
    /// </summary>
    [DataContract(Name = "PatchDashboardRequest_2")]
    public partial class PatchDashboardRequest2 : IEquatable<PatchDashboardRequest2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchDashboardRequest2" /> class.
        /// </summary>
        ...
        public PatchDashboardRequest2(string name = default(string), string description = default(string), CellWithViewProperties cells = default(CellWithViewProperties))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchDashboardRequest2 {\n");
        ...
        {
            return this.Equals(input as PatchDashboardRequest2);
        }

        /// <summary>
        /// Returns true if PatchDashboardRequest2 instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchDashboardRequest2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchDashboardRequest2 input)
        {
            if (input == null)
                return false;
