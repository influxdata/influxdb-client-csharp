...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "HTTPNotificationEndpoint")]
    public partial class HTTPNotificationEndpoint : NotificationEndpoint, IEquatable<HTTPNotificationEndpoint>
    {
        ...
        public HTTPNotificationEndpoint(string id = default(string), string orgID = default(string), string userID = default(string), string description = default(string), string name = default(string), StatusEnum? status = StatusEnum.Active, List<Label> labels = default(List<Label>), NotificationEndpointBaseLinks links = default(NotificationEndpointBaseLinks), NotificationEndpointType type = default(NotificationEndpointType), string url = default(string), string username = default(string), string password = default(string), string token = default(string), MethodEnum method = default(MethodEnum), AuthMethodEnum authMethod = default(AuthMethodEnum), string contentTemplate = default(string), Dictionary<string, string> headers = default(Dictionary<string, string>)) : base(id, orgID, userID, description, name, status, labels, links)
        {
            this.Type = type;
            // to ensure "url" is required (not null)
            if (url == null) {
                throw new ArgumentNullException("url is a required property for HTTPNotificationEndpoint and cannot be null");
            }
            this.Url = url;
            this.Method = method;
