...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// TelegrafAllOfLinks
    /// </summary>
    [DataContract(Name = "Telegraf_allOf_links")]
    public partial class TelegrafAllOfLinks : IEquatable<TelegrafAllOfLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TelegrafAllOfLinks" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TelegrafAllOfLinks);
        }

        /// <summary>
        /// Returns true if TelegrafAllOfLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of TelegrafAllOfLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TelegrafAllOfLinks input)
        {
            if (input == null)
                return false;
