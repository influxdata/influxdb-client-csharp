...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class IndexExpression : Expression, IEquatable<IndexExpression>
    {
        ...
        public IndexExpression(string type = default, Expression array = default, Expression index = default) : base()
        {
            Type = type;
            Array = array;
            Index = index;
        ...
        {
            return Equals(input as IndexExpression);
        }
        ...
        public bool Equals(IndexExpression input)
        {
            ...
            return base.Equals(input) &&
                   ...
                   ) && base.Equals(input) && Array != null && Array.Equals(input.Array) && base.Equals(input) &&
