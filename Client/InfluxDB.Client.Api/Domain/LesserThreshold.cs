...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// LesserThreshold
    /// </summary>
    [DataContract(Name = "LesserThreshold")]
    public partial class LesserThreshold : Threshold, IEquatable<LesserThreshold>
    {
        ...
        public LesserThreshold(CheckStatusLevel? level = default(CheckStatusLevel?), bool allValues = default(bool), TypeEnum type = default(TypeEnum), float value = default(float)) : base(level, allValues)
        {
            this.Type = type;
            this.Value = value;
        }
