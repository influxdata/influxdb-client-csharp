...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "ScraperTargetResponse")]
    public partial class ScraperTargetResponse : IEquatable<ScraperTargetResponse>
    {
        /// <summary>
        ...
        [DataMember(Name = "allowInsecure", EmitDefaultValue = true)]
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AllowInsecure.GetHashCode();
                if (this.Id != null)
