...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class TemplateSummaryDiffDashboards : IEquatable<TemplateSummaryDiffDashboards>
    {
        ...
        public TemplateSummaryDiffDashboards(string stateStatus = default, string id = default,
            TemplateKind? kind = default, string templateMetaName = default,
            TemplateSummaryDiffDashboardsNewOld _new = default, TemplateSummaryDiffDashboardsNewOld old = default)
        {
        ...
        {
            return Equals(input as TemplateSummaryDiffDashboards);
        }
