...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionManifest")]
    public partial class SubscriptionManifest : IEquatable<SubscriptionManifest>
    {
        ...
        public SubscriptionManifest(string name = default(string), string mode = default(string), List<string> destinations = default(List<string>))
        {
            ...
            if (name == null) {
                throw new ArgumentNullException("name is a required property for SubscriptionManifest and cannot be null");
            }
            this.Name = name;
            // to ensure "mode" is required (not null)
            if (mode == null) {
                throw new ArgumentNullException("mode is a required property for SubscriptionManifest and cannot be null");
            }
            this.Mode = mode;
            // to ensure "destinations" is required (not null)
            if (destinations == null) {
                throw new ArgumentNullException("destinations is a required property for SubscriptionManifest and cannot be null");
            }
