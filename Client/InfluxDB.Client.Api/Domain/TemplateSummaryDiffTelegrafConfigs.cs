...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateSummaryDiffTelegrafConfigs :  IEquatable<TemplateSummaryDiffTelegrafConfigs>
    {
        /// <summary>
        /// Gets or Sets Kind
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateSummaryDiffTelegrafConfigs" /> class.
        /// </summary>
        ...
        public TemplateSummaryDiffTelegrafConfigs(TemplateKind? kind = default(TemplateKind?), string stateStatus = default(string), string id = default(string), string templateMetaName = default(string), TelegrafRequest _new = default(TelegrafRequest), TelegrafRequest old = default(TelegrafRequest))
        {
            this.Kind = kind;
        ...
        {
            return this.Equals(input as TemplateSummaryDiffTelegrafConfigs);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TemplateSummaryDiffTelegrafConfigs input)
        {
            if (input == null)
                return false;
