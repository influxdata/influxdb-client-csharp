...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class TemplateSummaryDiffTelegrafConfigs : IEquatable<TemplateSummaryDiffTelegrafConfigs>
    {
        ...
        public TemplateSummaryDiffTelegrafConfigs(TemplateKind? kind = default, string stateStatus = default,
            string id = default, string templateMetaName = default, TelegrafRequest _new = default,
            TelegrafRequest old = default)
        {
            Kind = kind;
        ...
        {
            return Equals(input as TemplateSummaryDiffTelegrafConfigs);
        }
