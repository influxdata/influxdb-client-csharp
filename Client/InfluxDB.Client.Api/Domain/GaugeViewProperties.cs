...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// GaugeViewProperties
    /// </summary>
    [DataContract(Name = "GaugeViewProperties")]
    public partial class GaugeViewProperties : ViewProperties, IEquatable<GaugeViewProperties>
    {
        ...
        public GaugeViewProperties(TypeEnum type = default(TypeEnum), List<DashboardQuery> queries = default(List<DashboardQuery>), List<DashboardColor> colors = default(List<DashboardColor>), ShapeEnum shape = default(ShapeEnum), string note = default(string), bool showNoteWhenEmpty = default(bool), string prefix = default(string), string tickPrefix = default(string), string suffix = default(string), string tickSuffix = default(string), DecimalPlaces decimalPlaces = default(DecimalPlaces)) : base()
        {
            this.Type = type;
            // to ensure "queries" is required (not null)
            if (queries == null) {
                throw new ArgumentNullException("queries is a required property for GaugeViewProperties and cannot be null");
            }
            this.Queries = queries;
            // to ensure "colors" is required (not null)
            if (colors == null) {
                throw new ArgumentNullException("colors is a required property for GaugeViewProperties and cannot be null");
            }
            this.Colors = colors;
            this.Shape = shape;
            // to ensure "note" is required (not null)
            if (note == null) {
                throw new ArgumentNullException("note is a required property for GaugeViewProperties and cannot be null");
            }
            this.Note = note;
            this.ShowNoteWhenEmpty = showNoteWhenEmpty;
            // to ensure "prefix" is required (not null)
            if (prefix == null) {
                throw new ArgumentNullException("prefix is a required property for GaugeViewProperties and cannot be null");
            }
            this.Prefix = prefix;
            // to ensure "tickPrefix" is required (not null)
            if (tickPrefix == null) {
                throw new ArgumentNullException("tickPrefix is a required property for GaugeViewProperties and cannot be null");
            }
            this.TickPrefix = tickPrefix;
            // to ensure "suffix" is required (not null)
            if (suffix == null) {
                throw new ArgumentNullException("suffix is a required property for GaugeViewProperties and cannot be null");
            }
            this.Suffix = suffix;
            // to ensure "tickSuffix" is required (not null)
            if (tickSuffix == null) {
                throw new ArgumentNullException("tickSuffix is a required property for GaugeViewProperties and cannot be null");
            }
            this.TickSuffix = tickSuffix;
            // to ensure "decimalPlaces" is required (not null)
            if (decimalPlaces == null) {
                throw new ArgumentNullException("decimalPlaces is a required property for GaugeViewProperties and cannot be null");
            }
