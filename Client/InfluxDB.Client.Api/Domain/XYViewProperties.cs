...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// XYViewProperties
    /// </summary>
    [DataContract(Name = "XYViewProperties")]
    public partial class XYViewProperties : ViewProperties, IEquatable<XYViewProperties>
    {
        ...
        public bool Equals(XYViewProperties input)
        {
            ...
            return base.Equals(input) && 
                ...
                (
                    this.ColorMapping == input.ColorMapping ||
                    this.ColorMapping != null &&
                    input.ColorMapping != null &&
                    this.ColorMapping.SequenceEqual(input.ColorMapping)
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ColorMapping != null)
                    hashCode = hashCode * 59 + this.ColorMapping.GetHashCode();
