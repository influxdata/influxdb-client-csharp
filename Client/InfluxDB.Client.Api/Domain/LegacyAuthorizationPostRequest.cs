...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "LegacyAuthorizationPostRequest")]
    public partial class LegacyAuthorizationPostRequest : IEquatable<LegacyAuthorizationPostRequest>
    {
        /// <summary>
        ...
        protected LegacyAuthorizationPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyAuthorizationPostRequest" /> class.
        /// </summary>
        ...
        public LegacyAuthorizationPostRequest(StatusEnum? status = StatusEnum.Active, string description = default(string), string orgID = default(string), string userID = default(string), string token = default(string), List<Permission> permissions = default(List<Permission>))
        {
            // to ensure "orgID" is required (not null)
            if (orgID == null) {
                throw new ArgumentNullException("orgID is a required property for LegacyAuthorizationPostRequest and cannot be null");
            }
            this.OrgID = orgID;
            // to ensure "permissions" is required (not null)
            if (permissions == null) {
                throw new ArgumentNullException("permissions is a required property for LegacyAuthorizationPostRequest and cannot be null");
            }
