...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class LogicalExpression : Expression,  IEquatable<LogicalExpression>
    {
        ...
        public LogicalExpression(string type = default(string), string _operator = default(string), Expression left = default(Expression), Expression right = default(Expression)) : base()
        {
            this.Type = type;
        ...
        public bool Equals(LogicalExpression input)
        {
            ...
            return base.Equals(input) && 
                ...
                (
                    ...
                    (this.Left != null && this.Left.Equals(input.Left))
                ) && base.Equals(input) && 
                (
                    
                    (this.Right != null && this.Right.Equals(input.Right))
                );
        }
