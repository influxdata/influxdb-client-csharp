...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class LogicalExpression : Expression, IEquatable<LogicalExpression>
    {
        /// <summary>
        ...
        public LogicalExpression(string type = default, string _operator = default, Expression left = default,
            Expression right = default) : base()
        {
            Type = type;
            Operator = _operator;
            Left = left;
        ...
        {
            return Equals(input as LogicalExpression);
        }
        ...
        public bool Equals(LogicalExpression input)
        {
            ...
            return base.Equals(input) &&
                   ...
                   ) && base.Equals(input) && Left != null && Left.Equals(input.Left) && base.Equals(input) &&
                   Right != null && Right.Equals(input.Right);
        }
