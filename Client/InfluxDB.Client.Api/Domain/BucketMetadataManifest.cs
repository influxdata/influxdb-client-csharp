...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "BucketMetadataManifest")]
    public partial class BucketMetadataManifest : IEquatable<BucketMetadataManifest>
    {
        ...
        public BucketMetadataManifest(string organizationID = default(string), string organizationName = default(string), string bucketID = default(string), string bucketName = default(string), string description = default(string), string defaultRetentionPolicy = default(string), List<RetentionPolicyManifest> retentionPolicies = default(List<RetentionPolicyManifest>))
        {
            ...
            if (organizationID == null) {
                throw new ArgumentNullException("organizationID is a required property for BucketMetadataManifest and cannot be null");
            }
            this.OrganizationID = organizationID;
            // to ensure "organizationName" is required (not null)
            if (organizationName == null) {
                throw new ArgumentNullException("organizationName is a required property for BucketMetadataManifest and cannot be null");
            }
            this.OrganizationName = organizationName;
            // to ensure "bucketID" is required (not null)
            if (bucketID == null) {
                throw new ArgumentNullException("bucketID is a required property for BucketMetadataManifest and cannot be null");
            }
            this.BucketID = bucketID;
            // to ensure "bucketName" is required (not null)
            if (bucketName == null) {
                throw new ArgumentNullException("bucketName is a required property for BucketMetadataManifest and cannot be null");
            }
            this.BucketName = bucketName;
            // to ensure "defaultRetentionPolicy" is required (not null)
            if (defaultRetentionPolicy == null) {
                throw new ArgumentNullException("defaultRetentionPolicy is a required property for BucketMetadataManifest and cannot be null");
            }
            this.DefaultRetentionPolicy = defaultRetentionPolicy;
            // to ensure "retentionPolicies" is required (not null)
            if (retentionPolicies == null) {
                throw new ArgumentNullException("retentionPolicies is a required property for BucketMetadataManifest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "organizationName", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "bucketName", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "defaultRetentionPolicy", IsRequired = true, EmitDefaultValue = false)]
        public string DefaultRetentionPolicy { get; set; }

        /// <summary>
        /// Gets or Sets RetentionPolicies
        /// </summary>
        [DataMember(Name = "retentionPolicies", IsRequired = true, EmitDefaultValue = false)]
