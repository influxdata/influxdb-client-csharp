...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class Replication : IEquatable<Replication>
    {
        ...
        public Replication(string id = default(string), string name = default(string), string description = default(string), string orgID = default(string), string remoteID = default(string), string localBucketID = default(string), string remoteBucketID = default(string), long maxQueueSizeBytes = default(long), long currentQueueSizeBytes = default(long), int latestResponseCode = default(int), string latestErrorMessage = default(string), bool dropNonRetryableData = default(bool))
        {
            ...
            if (id == null) {
                throw new ArgumentNullException("id is a required property for Replication and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for Replication and cannot be null");
            }
            this.Name = name;
            // to ensure "orgID" is required (not null)
            if (orgID == null) {
                throw new ArgumentNullException("orgID is a required property for Replication and cannot be null");
            }
            this.OrgID = orgID;
            // to ensure "remoteID" is required (not null)
            if (remoteID == null) {
                throw new ArgumentNullException("remoteID is a required property for Replication and cannot be null");
            }
            this.RemoteID = remoteID;
            // to ensure "localBucketID" is required (not null)
            if (localBucketID == null) {
                throw new ArgumentNullException("localBucketID is a required property for Replication and cannot be null");
            }
            this.LocalBucketID = localBucketID;
            // to ensure "remoteBucketID" is required (not null)
            if (remoteBucketID == null) {
                throw new ArgumentNullException("remoteBucketID is a required property for Replication and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "currentQueueSizeBytes", IsRequired = true, EmitDefaultValue = false)]
