...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class TelegramNotificationRule : TelegramNotificationRuleBase, IEquatable<TelegramNotificationRule>
    {
        ...
        /// Initializes a new instance of the <see cref="TelegramNotificationRule" /> class.
        /// </summary>
        public TelegramNotificationRule(string endpointID = default, string orgID = default, string taskID = default,
            ...
            List<Label> labels = default, NotificationRuleBaseLinks links = default, TypeEnum type = TypeEnum.Telegram,
            string messageTemplate = default, ParseModeEnum? parseMode = default, bool? disableWebPagePreview = default)
            : base(type, messageTemplate, parseMode, disableWebPagePreview, endpointID, orgID, taskID, status, name,
        ...
        {
            return Equals(input as TelegramNotificationRule);
        }
