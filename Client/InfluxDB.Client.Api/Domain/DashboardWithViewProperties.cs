...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardWithViewProperties")]
    public partial class DashboardWithViewProperties : IEquatable<DashboardWithViewProperties>
    {
        /// <summary>
        ...
        public DashboardWithViewProperties(string orgID = default(string), string name = default(string), string description = default(string), DashboardWithViewPropertiesAllOfLinks links = default(DashboardWithViewPropertiesAllOfLinks), DashboardWithViewPropertiesAllOfMeta meta = default(DashboardWithViewPropertiesAllOfMeta), List<CellWithViewProperties> cells = default(List<CellWithViewProperties>), List<Label> labels = default(List<Label>))
        {
            // to ensure "orgID" is required (not null)
            if (orgID == null) {
                throw new ArgumentNullException("orgID is a required property for DashboardWithViewProperties and cannot be null");
            }
            this.OrgID = orgID;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for DashboardWithViewProperties and cannot be null");
            }
            this.Name = name;
