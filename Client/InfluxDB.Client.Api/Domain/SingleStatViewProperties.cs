...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class SingleStatViewProperties : ViewProperties, IEquatable<SingleStatViewProperties>
    {
        ...
        public enum TypeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "single-stat")] SingleStat = 1
        }
        ...
        public SingleStatViewProperties(TypeEnum type = TypeEnum.SingleStat, List<DashboardQuery> queries = default,
            ...
            string suffix = default, string tickSuffix = default, StaticLegend staticLegend = default,
            DecimalPlaces decimalPlaces = default) : base()
        {
            ...
            if (queries == null)
            {
                throw new InvalidDataException(
                    "queries is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "colors is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "note is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "showNoteWhenEmpty is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "prefix is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "tickPrefix is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "suffix is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "tickSuffix is a required property for SingleStatViewProperties and cannot be null");
            }
            ...
            {
                throw new InvalidDataException(
                    "decimalPlaces is a required property for SingleStatViewProperties and cannot be null");
            }
        ...
        {
            return Equals(input as SingleStatViewProperties);
        }
        ...
        public bool Equals(SingleStatViewProperties input)
        {
            ...
            return base.Equals(input) &&
                   ...
                   ) && base.Equals(input) && StaticLegend != null && StaticLegend.Equals(input.StaticLegend) &&
