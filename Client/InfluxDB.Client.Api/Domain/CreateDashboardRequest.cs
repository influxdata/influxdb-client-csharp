...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "CreateDashboardRequest")]
    public partial class CreateDashboardRequest : IEquatable<CreateDashboardRequest>
    {
        ...
        public CreateDashboardRequest(string orgID = default(string), string name = default(string), string description = default(string))
        {
            ...
            if (orgID == null) {
                throw new ArgumentNullException("orgID is a required property for CreateDashboardRequest and cannot be null");
            }
            this.OrgID = orgID;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CreateDashboardRequest and cannot be null");
            }
            this.Name = name;
