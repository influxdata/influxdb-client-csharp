...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "LinePlusSingleStatProperties")]
    public partial class LinePlusSingleStatProperties : ViewProperties, IEquatable<LinePlusSingleStatProperties>
    {
        ...
        public LinePlusSingleStatProperties(string timeFormat = default(string), TypeEnum type = default(TypeEnum), List<DashboardQuery> queries = default(List<DashboardQuery>), List<DashboardColor> colors = default(List<DashboardColor>), ShapeEnum shape = default(ShapeEnum), string note = default(string), bool showNoteWhenEmpty = default(bool), Axes axes = default(Axes), StaticLegend staticLegend = default(StaticLegend), string xColumn = default(string), List<string> generateXAxisTicks = default(List<string>), int xTotalTicks = default(int), float xTickStart = default(float), float xTickStep = default(float), string yColumn = default(string), List<string> generateYAxisTicks = default(List<string>), int yTotalTicks = default(int), float yTickStart = default(float), float yTickStep = default(float), bool shadeBelow = default(bool), HoverDimensionEnum? hoverDimension = default(HoverDimensionEnum?), PositionEnum position = default(PositionEnum), string prefix = default(string), string suffix = default(string), DecimalPlaces decimalPlaces = default(DecimalPlaces), bool legendColorizeRows = default(bool), bool legendHide = default(bool), float legendOpacity = default(float), int legendOrientationThreshold = default(int)) : base()
        {
            ...
            if (queries == null) {
                throw new ArgumentNullException("queries is a required property for LinePlusSingleStatProperties and cannot be null");
            }
            this.Queries = queries;
            // to ensure "colors" is required (not null)
            if (colors == null) {
                throw new ArgumentNullException("colors is a required property for LinePlusSingleStatProperties and cannot be null");
            }
            this.Colors = colors;
            this.Shape = shape;
            // to ensure "note" is required (not null)
            if (note == null) {
                throw new ArgumentNullException("note is a required property for LinePlusSingleStatProperties and cannot be null");
            }
            this.Note = note;
            this.ShowNoteWhenEmpty = showNoteWhenEmpty;
            // to ensure "axes" is required (not null)
            if (axes == null) {
                throw new ArgumentNullException("axes is a required property for LinePlusSingleStatProperties and cannot be null");
            }
            this.Axes = axes;
            this.Position = position;
            // to ensure "prefix" is required (not null)
            if (prefix == null) {
                throw new ArgumentNullException("prefix is a required property for LinePlusSingleStatProperties and cannot be null");
            }
            this.Prefix = prefix;
            // to ensure "suffix" is required (not null)
            if (suffix == null) {
                throw new ArgumentNullException("suffix is a required property for LinePlusSingleStatProperties and cannot be null");
            }
            this.Suffix = suffix;
            // to ensure "decimalPlaces" is required (not null)
            if (decimalPlaces == null) {
                throw new ArgumentNullException("decimalPlaces is a required property for LinePlusSingleStatProperties and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "shadeBelow", EmitDefaultValue = true)]
