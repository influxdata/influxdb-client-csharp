...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "ScatterViewProperties")]
    public partial class ScatterViewProperties : ViewProperties, IEquatable<ScatterViewProperties>
    {
        ...
        public ScatterViewProperties(string timeFormat = default(string), TypeEnum type = default(TypeEnum), List<DashboardQuery> queries = default(List<DashboardQuery>), List<string> colors = default(List<string>), ShapeEnum shape = default(ShapeEnum), string note = default(string), bool showNoteWhenEmpty = default(bool), string xColumn = default(string), List<string> generateXAxisTicks = default(List<string>), int xTotalTicks = default(int), float xTickStart = default(float), float xTickStep = default(float), string yColumn = default(string), List<string> generateYAxisTicks = default(List<string>), int yTotalTicks = default(int), float yTickStart = default(float), float yTickStep = default(float), List<string> fillColumns = default(List<string>), List<string> symbolColumns = default(List<string>), List<decimal> xDomain = default(List<decimal>), List<decimal> yDomain = default(List<decimal>), string xAxisLabel = default(string), string yAxisLabel = default(string), string xPrefix = default(string), string xSuffix = default(string), string yPrefix = default(string), string ySuffix = default(string), bool legendColorizeRows = default(bool), bool legendHide = default(bool), float legendOpacity = default(float), int legendOrientationThreshold = default(int)) : base()
        {
            ...
            if (queries == null) {
                throw new ArgumentNullException("queries is a required property for ScatterViewProperties and cannot be null");
            }
            this.Queries = queries;
            // to ensure "colors" is required (not null)
            if (colors == null) {
                throw new ArgumentNullException("colors is a required property for ScatterViewProperties and cannot be null");
            }
            this.Colors = colors;
            this.Shape = shape;
            // to ensure "note" is required (not null)
            if (note == null) {
                throw new ArgumentNullException("note is a required property for ScatterViewProperties and cannot be null");
            }
            this.Note = note;
            this.ShowNoteWhenEmpty = showNoteWhenEmpty;
            // to ensure "xColumn" is required (not null)
            if (xColumn == null) {
                throw new ArgumentNullException("xColumn is a required property for ScatterViewProperties and cannot be null");
            }
            this.XColumn = xColumn;
            // to ensure "yColumn" is required (not null)
            if (yColumn == null) {
                throw new ArgumentNullException("yColumn is a required property for ScatterViewProperties and cannot be null");
            }
            this.YColumn = yColumn;
            // to ensure "fillColumns" is required (not null)
            if (fillColumns == null) {
                throw new ArgumentNullException("fillColumns is a required property for ScatterViewProperties and cannot be null");
            }
            this.FillColumns = fillColumns;
            // to ensure "symbolColumns" is required (not null)
            if (symbolColumns == null) {
                throw new ArgumentNullException("symbolColumns is a required property for ScatterViewProperties and cannot be null");
            }
            this.SymbolColumns = symbolColumns;
            // to ensure "xDomain" is required (not null)
            if (xDomain == null) {
                throw new ArgumentNullException("xDomain is a required property for ScatterViewProperties and cannot be null");
            }
            this.XDomain = xDomain;
            // to ensure "yDomain" is required (not null)
            if (yDomain == null) {
                throw new ArgumentNullException("yDomain is a required property for ScatterViewProperties and cannot be null");
            }
            this.YDomain = yDomain;
            // to ensure "xAxisLabel" is required (not null)
            if (xAxisLabel == null) {
                throw new ArgumentNullException("xAxisLabel is a required property for ScatterViewProperties and cannot be null");
            }
            this.XAxisLabel = xAxisLabel;
            // to ensure "yAxisLabel" is required (not null)
            if (yAxisLabel == null) {
                throw new ArgumentNullException("yAxisLabel is a required property for ScatterViewProperties and cannot be null");
            }
            this.YAxisLabel = yAxisLabel;
            // to ensure "xPrefix" is required (not null)
            if (xPrefix == null) {
                throw new ArgumentNullException("xPrefix is a required property for ScatterViewProperties and cannot be null");
            }
            this.XPrefix = xPrefix;
            // to ensure "xSuffix" is required (not null)
            if (xSuffix == null) {
                throw new ArgumentNullException("xSuffix is a required property for ScatterViewProperties and cannot be null");
            }
            this.XSuffix = xSuffix;
            // to ensure "yPrefix" is required (not null)
            if (yPrefix == null) {
                throw new ArgumentNullException("yPrefix is a required property for ScatterViewProperties and cannot be null");
            }
            this.YPrefix = yPrefix;
            // to ensure "ySuffix" is required (not null)
            if (ySuffix == null) {
                throw new ArgumentNullException("ySuffix is a required property for ScatterViewProperties and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "symbolColumns", IsRequired = true, EmitDefaultValue = false)]
