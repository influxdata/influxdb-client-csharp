...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardColor")]
    public partial class DashboardColor : IEquatable<DashboardColor>
    {
        ...
        public DashboardColor(string id = default(string), TypeEnum type = default(TypeEnum), string hex = default(string), string name = default(string), float value = default(float))
        {
            ...
            if (id == null) {
                throw new ArgumentNullException("id is a required property for DashboardColor and cannot be null");
            }
            this.Id = id;
            this.Type = type;
            // to ensure "hex" is required (not null)
            if (hex == null) {
                throw new ArgumentNullException("hex is a required property for DashboardColor and cannot be null");
            }
            this.Hex = hex;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for DashboardColor and cannot be null");
            }
            this.Name = name;
            this.Value = value;
        }
