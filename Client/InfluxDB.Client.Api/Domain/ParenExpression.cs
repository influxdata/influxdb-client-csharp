...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParenExpression :  IEquatable<ParenExpression>
    {
        /// <summary>
        ...
        public ParenExpression(string type = default(string), Expression expression = default(Expression))
        {
            this.Type = type;
