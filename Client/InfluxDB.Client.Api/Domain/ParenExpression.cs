...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class ParenExpression : Expression, IEquatable<ParenExpression>
    {
        ...
        public ParenExpression(string type = default, Expression expression = default) : base()
        {
            Type = type;
        ...
        {
            return Equals(input as ParenExpression);
        }
        ...
        public bool Equals(ParenExpression input)
        {
            ...
            return base.Equals(input) &&
                   ...
                   ) && base.Equals(input) && Expression != null && Expression.Equals(input.Expression);
        }
