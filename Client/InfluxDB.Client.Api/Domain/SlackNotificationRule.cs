...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract(Name = "SlackNotificationRule")]
    public partial class SlackNotificationRule : SlackNotificationRuleBase, IEquatable<SlackNotificationRule>
    {
        ...
        public SlackNotificationRule(string endpointID = default(string), string orgID = default(string), string taskID = default(string), TaskStatusType status = default(TaskStatusType), string name = default(string), string sleepUntil = default(string), string every = default(string), string offset = default(string), string runbookLink = default(string), int limitEvery = default(int), int limit = default(int), List<TagRule> tagRules = default(List<TagRule>), string description = default(string), List<StatusRule> statusRules = default(List<StatusRule>), List<Label> labels = default(List<Label>), NotificationRuleBaseLinks links = default(NotificationRuleBaseLinks), TypeEnum type = default(TypeEnum), string channel = default(string), string messageTemplate = default(string)) : base(type, channel, messageTemplate, endpointID, orgID, taskID, status, name, sleepUntil, every, offset, runbookLink, limitEvery, limit, tagRules, description, statusRules, labels, links)
        {
        }
