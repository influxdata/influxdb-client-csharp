...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class MapVariableProperties : VariableProperties, IEquatable<MapVariableProperties>
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public MapVariableProperties(TypeEnum? type = default, Dictionary<string, string> values = default) : base()
        {
            Type = type;
            Values = values;
        }
        ...
        {
            return Equals(input as MapVariableProperties);
        }
