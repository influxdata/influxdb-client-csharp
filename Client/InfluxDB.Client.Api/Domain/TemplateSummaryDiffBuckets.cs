...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class TemplateSummaryDiffBuckets : IEquatable<TemplateSummaryDiffBuckets>
    {
        ...
        public TemplateSummaryDiffBuckets(TemplateKind? kind = default, string stateStatus = default,
            string id = default, string templateMetaName = default, TemplateSummaryDiffBucketsNewOld _new = default,
            TemplateSummaryDiffBucketsNewOld old = default)
        {
            Kind = kind;
        ...
        {
            return Equals(input as TemplateSummaryDiffBuckets);
        }
