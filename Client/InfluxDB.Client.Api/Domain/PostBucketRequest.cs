...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class PostBucketRequest :  IEquatable<PostBucketRequest>
    {
        ...
        public PostBucketRequest(string orgID = default(string), string name = default(string), string description = default(string), string rp = default(string), List<BucketRetentionRules> retentionRules = default(List<BucketRetentionRules>))
        {
