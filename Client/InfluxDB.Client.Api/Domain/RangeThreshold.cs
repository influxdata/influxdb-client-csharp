...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// RangeThreshold
    /// </summary>
    [DataContract(Name = "RangeThreshold")]
    public partial class RangeThreshold : Threshold, IEquatable<RangeThreshold>
    {
        ...
        public RangeThreshold(CheckStatusLevel? level = default(CheckStatusLevel?), bool allValues = default(bool), TypeEnum type = default(TypeEnum), float min = default(float), float max = default(float), bool within = default(bool)) : base(level, allValues)
        {
            this.Type = type;
            this.Min = min;
            this.Max = max;
