...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateSummaryDiffVariables :  IEquatable<TemplateSummaryDiffVariables>
    {
        /// <summary>
        /// Gets or Sets Kind
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateSummaryDiffVariables" /> class.
        /// </summary>
        ...
        public TemplateSummaryDiffVariables(TemplateKind? kind = default(TemplateKind?), string stateStatus = default(string), string id = default(string), string templateMetaName = default(string), TemplateSummaryDiffVariablesNewOld _new = default(TemplateSummaryDiffVariablesNewOld), TemplateSummaryDiffVariablesNewOld old = default(TemplateSummaryDiffVariablesNewOld))
        {
            this.Kind = kind;
        ...
        public TemplateSummaryDiffVariablesNewOld New { get; set; }

        /// <summary>
        /// Gets or Sets Old
        /// </summary>
        [DataMember(Name="old", EmitDefaultValue=false)]
        public TemplateSummaryDiffVariablesNewOld Old { get; set; }
        ...
        {
            return this.Equals(input as TemplateSummaryDiffVariables);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TemplateSummaryDiffVariables input)
        {
            if (input == null)
                return false;
