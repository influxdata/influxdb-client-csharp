...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class TemplateSummaryDiffVariables : IEquatable<TemplateSummaryDiffVariables>
    {
        ...
        public TemplateSummaryDiffVariables(TemplateKind? kind = default, string stateStatus = default,
            string id = default, string templateMetaName = default, TemplateSummaryDiffVariablesNewOld _new = default,
            TemplateSummaryDiffVariablesNewOld old = default)
        {
            Kind = kind;
        ...
        {
            return Equals(input as TemplateSummaryDiffVariables);
        }
