...
namespace InfluxDB.Client.Api.Service
{
    ...
    public interface IRulesService : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FluxResponse> GetNotificationRulesIDQueryAsync(string ruleID,
        ...
        System.Threading.Tasks.Task<ApiResponse<FluxResponse>> GetNotificationRulesIDQueryAsyncWithHttpInfo(
    ...
    public partial class RulesService : IRulesService
    {
        ...
        {
            var localVarResponse = GetNotificationRulesIDQueryWithHttpInfo(ruleID, zapTraceSpan);
        ...
        /// <param name="zapTraceSpan">OpenTracing span context (optional)</param>
        /// <returns>ApiResponse of FluxResponse</returns>
        public ApiResponse<FluxResponse> GetNotificationRulesIDQueryWithHttpInfo(string ruleID,
            string zapTraceSpan = null)
        {
            ...
            if (ruleID == null)
            {
                throw new ApiException(400,
                    "Missing required parameter 'ruleID' when calling RulesService->GetNotificationRulesIDQuery");
            }
            ...
            {
                var exception = ExceptionFactory("GetNotificationRulesIDQuery", localVarResponse);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>ApiResponse of FluxResponse</returns>
        public async System.Threading.Tasks.Task<RestResponse> GetNotificationRulesIDQueryWithIRestResponseAsync(
            string ruleID, string zapTraceSpan = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'ruleID' is set
            if (ruleID == null)
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Task of FluxResponse</returns>
        public async System.Threading.Tasks.Task<FluxResponse> GetNotificationRulesIDQueryAsync(string ruleID,
            string zapTraceSpan = null, CancellationToken cancellationToken = default)
        {
            var localVarResponse =
                await GetNotificationRulesIDQueryAsyncWithHttpInfo(ruleID, zapTraceSpan, cancellationToken)
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Task of ApiResponse (FluxResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FluxResponse>>
            GetNotificationRulesIDQueryAsyncWithHttpInfo(string ruleID, string zapTraceSpan = null,
                CancellationToken cancellationToken = default)
        {
            // make the HTTP request
            var localVarResponse =
                await GetNotificationRulesIDQueryAsyncWithIRestResponse(ruleID, zapTraceSpan, cancellationToken)
                    .ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<RestResponse> GetNotificationRulesIDQueryAsyncWithIRestResponse(
            string ruleID, string zapTraceSpan = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'ruleID' is set
            if (ruleID == null)
