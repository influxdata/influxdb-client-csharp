...
namespace InfluxDB.Client.Api.Service
{
    ...
    public partial class NotificationRulesService : INotificationRulesService
    {
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>ApiResponse of NotificationRule</returns>
        public async System.Threading.Tasks.Task<IRestResponse> CreateNotificationRuleWithIRestResponseAsync (NotificationRule notificationRule, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'notificationRule' is set
            if (notificationRule == null)
                throw new ApiException(400, "Missing required parameter 'notificationRule' when calling NotificationRulesService->CreateNotificationRule");
        ...
        {
            // make the HTTP request
            IRestResponse localVarResponse = await CreateNotificationRuleAsyncWithIRestResponse(notificationRule, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<IRestResponse> CreateNotificationRuleAsyncWithIRestResponse (NotificationRule notificationRule, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'notificationRule' is set
            if (notificationRule == null)
                throw new ApiException(400, "Missing required parameter 'notificationRule' when calling NotificationRulesService->CreateNotificationRule");
