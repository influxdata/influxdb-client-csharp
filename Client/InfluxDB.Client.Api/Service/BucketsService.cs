...
namespace InfluxDB.Client.Api.Service
{
    ...
    public partial class BucketsService : IBucketsService
    {
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>ApiResponse of Buckets</returns>
        public async System.Threading.Tasks.Task<IRestResponse> GetBucketsWithIRestResponseAsync (string zapTraceSpan = null, int? offset = null, int? limit = null, string after = null, string org = null, string orgID = null, string name = null, string id = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="id">Only returns buckets with a specific ID. (optional)</param>
        /// <returns>ApiResponse of Buckets</returns>
        public IRestResponse GetBucketsWithIRestResponse (string zapTraceSpan = null, int? offset = null, int? limit = null, string after = null, string org = null, string orgID = null, string name = null, string id = null)
        {
        ...
        {
            // make the HTTP request
            IRestResponse localVarResponse = await GetBucketsAsyncWithIRestResponse(zapTraceSpan, offset, limit, after, org, orgID, name, id, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<IRestResponse> GetBucketsAsyncWithIRestResponse (string zapTraceSpan = null, int? offset = null, int? limit = null, string after = null, string org = null, string orgID = null, string name = null, string id = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>ApiResponse of Bucket</returns>
        public async System.Threading.Tasks.Task<IRestResponse> PatchBucketsIDWithIRestResponseAsync (string bucketID, PatchBucketRequest patchBucketRequest, string zapTraceSpan = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'bucketID' is set
            if (bucketID == null)
                throw new ApiException(400, "Missing required parameter 'bucketID' when calling BucketsService->PatchBucketsID");
        ...
        /// <param name="zapTraceSpan">OpenTracing span context (optional)</param>
        /// <returns>ApiResponse of Bucket</returns>
        public IRestResponse PatchBucketsIDWithIRestResponse (string bucketID, PatchBucketRequest patchBucketRequest, string zapTraceSpan = null)
        {
            // verify the required parameter 'bucketID' is set
            if (bucketID == null)
                throw new ApiException(400, "Missing required parameter 'bucketID' when calling BucketsService->PatchBucketsID");
        ...
        {
            // make the HTTP request
            IRestResponse localVarResponse = await PatchBucketsIDAsyncWithIRestResponse(bucketID, patchBucketRequest, zapTraceSpan, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Task of IRestResponse (Bucket)</returns>
        public async System.Threading.Tasks.Task<IRestResponse> PatchBucketsIDAsyncWithIRestResponse (string bucketID, PatchBucketRequest patchBucketRequest, string zapTraceSpan = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'bucketID' is set
            if (bucketID == null)
                throw new ApiException(400, "Missing required parameter 'bucketID' when calling BucketsService->PatchBucketsID");
