...
namespace InfluxDB.Client.Api.Service
{
    ...
    public partial class DeleteService : IDeleteService
    {
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public async System.Threading.Tasks.Task<IRestResponse> PostDeleteWithIRestResponseAsync (DeletePredicateRequest deletePredicateRequest, string zapTraceSpan = null, string org = null, string bucket = null, string orgID = null, string bucketID = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'deletePredicateRequest' is set
            if (deletePredicateRequest == null)
                throw new ApiException(400, "Missing required parameter 'deletePredicateRequest' when calling DeleteService->PostDelete");
        ...
        /// <param name="bucketID">Specifies the bucket ID to delete data from. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public IRestResponse PostDeleteWithIRestResponse (DeletePredicateRequest deletePredicateRequest, string zapTraceSpan = null, string org = null, string bucket = null, string orgID = null, string bucketID = null)
        {
            // verify the required parameter 'deletePredicateRequest' is set
            if (deletePredicateRequest == null)
                throw new ApiException(400, "Missing required parameter 'deletePredicateRequest' when calling DeleteService->PostDelete");
        ...
        {
            // make the HTTP request
            IRestResponse localVarResponse = await PostDeleteAsyncWithIRestResponse(deletePredicateRequest, zapTraceSpan, org, bucket, orgID, bucketID, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<IRestResponse> PostDeleteAsyncWithIRestResponse (DeletePredicateRequest deletePredicateRequest, string zapTraceSpan = null, string org = null, string bucket = null, string orgID = null, string bucketID = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'deletePredicateRequest' is set
            if (deletePredicateRequest == null)
                throw new ApiException(400, "Missing required parameter 'deletePredicateRequest' when calling DeleteService->PostDelete");
