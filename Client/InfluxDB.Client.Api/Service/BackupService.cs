...
namespace InfluxDB.Client.Api.Service
{
    ...
    public partial class BackupService : IBackupService
    {
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>ApiResponse of MetadataBackup</returns>
        public async System.Threading.Tasks.Task<IRestResponse> GetBackupMetadataWithIRestResponseAsync (string zapTraceSpan = null, string acceptEncoding = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="acceptEncoding">The Accept-Encoding request HTTP header advertises which content encoding, usually a compression algorithm, the client is able to understand. (optional, default to identity)</param>
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Task of IRestResponse (MetadataBackup)</returns>
        public async System.Threading.Tasks.Task<IRestResponse> GetBackupMetadataAsyncWithIRestResponse (string zapTraceSpan = null, string acceptEncoding = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<IRestResponse> GetBackupShardIdWithIRestResponseAsync (long? shardID, string zapTraceSpan = null, string acceptEncoding = null, DateTime? since = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'shardID' is set
            if (shardID == null)
                throw new ApiException(400, "Missing required parameter 'shardID' when calling BackupService->GetBackupShardId");
        ...
        /// <param name="since">Earliest time to include in the snapshot. RFC3339 format. (optional)</param>
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Task of IRestResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<IRestResponse> GetBackupShardIdAsyncWithIRestResponse (long? shardID, string zapTraceSpan = null, string acceptEncoding = null, DateTime? since = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'shardID' is set
            if (shardID == null)
                throw new ApiException(400, "Missing required parameter 'shardID' when calling BackupService->GetBackupShardId");
