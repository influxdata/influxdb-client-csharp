...
namespace Platform.Client.Tests
{
    ...
    public class PointTest
    {
        ...
        public void MeasurementEscape()
        {
            ...
            Assert.AreEqual("h2\\ o,location=europe level=2i", point.ToString());
        ...
        public void TagEmptyKey()
        {
            ...
            Assert.AreEqual("h2o,location=europe level=2i", point.ToString());
        }
        ...
        public void OverrideTagField()
        {
            ...
            Assert.AreEqual("h2o,location=europe2 level=3i", point.ToString());
        }
        ...
        public void FieldEscape()
        {
            ...
            Assert.AreEqual("h2o,location=europe level=\"string esc\\\\ape value\"", point.ToString());
        ...
        public void Time()
        {
            ...
            Assert.AreEqual("h2o,location=europe level=2i 123", point.ToString());
        }
        ...
        public void TimeSpanFormatting()
        {
            ...
            Assert.AreEqual("h2o,location=europe level=2i 86400000000000", point.ToString());
            ...
            Assert.AreEqual("h2o,location=europe level=2i 1281600000000", point.ToString());
            ...
            Assert.AreEqual("h2o,location=europe level=2i 156000", point.ToString());
        ...
        public void DateTimeFormatting()
        {
            ...
            Assert.AreEqual("h2o,location=europe level=2i 1444897215000", point.ToString());
        }
        ...
        public void DateTimeOffsetFormatting()
        {
            ...
            Assert.AreEqual("h2o,location=europe level=2i 15678000000000", point.ToString());
        }
    }
}