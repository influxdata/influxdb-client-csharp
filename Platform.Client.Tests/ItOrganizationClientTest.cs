...
namespace Platform.Client.Tests
{
    ...
    public class ItOrganizationClientTest : AbstractItClientTest
    {
        ...
        {
            var entries = await _organizationClient.FindOrganizationLogs("020f755c3c082000", new FindOptions());
        ...
        {
            var logs = await _organizationClient.FindOrganizationLogs("020f755c3c082000");
        ...
        public async Task FindOrganizationLogsPaging()
        {
            ...
            foreach (var i in Enumerable.Range(0, 19))
            {
                ...
                await _organizationClient.UpdateOrganization(organization);
            }
