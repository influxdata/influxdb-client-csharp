...
namespace InfluxData.Platform.Client.Client
{
    public class QueryClient : AbstractQueryClient
    {
        ...
        /// <para>
        /// NOTE: This method is not intended for large query results.
        /// Use <see cref="Query{T}(string,string,System.Action{Platform.Common.Platform.Rest.ICancellable,T}(Platform.Common.Platform.Rest.ICancellable,T),Action{Exception},Action)"/>
        /// for large data streaming.
        /// </para>
        /// </summary>
        /// <param name="query">the flux query to execute</param>
