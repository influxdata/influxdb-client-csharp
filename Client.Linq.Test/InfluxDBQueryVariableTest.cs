...
namespace Client.Linq.Test
{
    ...
    public class InfluxDBQueryVariableTest : AbstractTest
    {
        ...
        public async Task OneTimeSetUp()
        {
            ...
            var point1 = new InfluxPoint() { TestTag = "my-tag", IntValue = -1000, ShortValue = -1000, 
                LongValue = -1000, DoubleValue = -1000, FloatValue = -1000, Timestamp =  _dateTime};
            var point2 = new InfluxPoint() { TestTag = "my-tag", IntValue = -450, ShortValue = -450, LongValue = -450, 
                DoubleValue = -450, FloatValue = -450, Timestamp =  _dateTime.AddSeconds(-1)};
            var point3 = new InfluxPoint() { TestTag = "my-tag", IntValue = -80, ShortValue = -80, LongValue = -80, 
                DoubleValue = -80, FloatValue = -80, Timestamp =  _dateTime.AddSeconds(-2)};
            var point4 = new InfluxPoint() { TestTag = "my-tag", IntValue = 65, ShortValue = 65, LongValue = 65, 
                DoubleValue = 65, FloatValue = 65, Timestamp =  _dateTime.AddSeconds(-3)};
            var point5 = new InfluxPoint() { TestTag = "my-tag", IntValue = 190, ShortValue = 190, LongValue = 190, 
                DoubleValue = 190, FloatValue = 190, Timestamp =  _dateTime.AddSeconds(-4)};
            var point6 = new InfluxPoint() { TestTag = "my-tag", IntValue = 350, ShortValue = 350, LongValue = 350, 
                DoubleValue = 350, FloatValue = 350, Timestamp =  _dateTime.AddSeconds(-5)};
            var point7 = new InfluxPoint() { TestTag = "my-tag", IntValue = 500, ShortValue = 500, LongValue = 500, 
                DoubleValue = 500, FloatValue = 500, Timestamp =  _dateTime.AddSeconds(-6)};
            var point8 = new InfluxPoint() { TestTag = "my-tag", IntValue = 750, ShortValue = 750, LongValue = 750, 
                DoubleValue = 750, FloatValue = 750, Timestamp =  _dateTime.AddSeconds(-7)};
            var point9 = new InfluxPoint() { TestTag = "my-tag", IntValue = 1100, ShortValue = 1100, LongValue = 1100, 
                DoubleValue = 1100, FloatValue = 1100, Timestamp =  _dateTime.AddSeconds(-8)};
            var point10 = new InfluxPoint() { TestTag = "my-tag", IntValue = 2535, ShortValue = 2535, LongValue = 2535, 
                DoubleValue = 2535, FloatValue = 2535, Timestamp =  _dateTime.AddSeconds(-9)};

            await _client
                .GetWriteApiAsync().WriteMeasurementsAsync(new[]{point1, point2, point3, point4, point5, point6, 
                        point7, point8, point9, point10}, WritePrecision.Ns, "test-bucket", "my-org");
        }
